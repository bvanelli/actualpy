...
class ValueType(enum.Enum):
    ...
    def validate(
        self, value: typing.Union[int, typing.List[str], str, None], operation: ConditionType | None = None
    ) -> bool:
...
class Rule(pydantic.BaseModel):
    ...
    stage: typing.Literal["pre", "post", None] = pydantic.Field(
        None, description="Stage in which the rulewill be evaluated (default None)"
    )
